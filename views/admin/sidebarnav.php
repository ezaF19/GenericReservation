        <div style="height: auto;" class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
            <div class="nano">
                <div class="nano-content">
                    <ul>
                        <div class="logo" style="padding-bottom: 20px;"><a href="<?php echo site_url('home');?>"><span style="font-size: 20px;">Generic Reservation</span></a></div>
                        <li class="label">Home</li>
                        <li style="font-size: 16px;"><a href="<?php echo site_url('home');?>"><i class="ti-home"></i> Dashboard</a></li>
                        <li class="label">Admin</li>
                        <li style="font-size: 16px;"><a href="<?php echo site_url('clients');?>"><i class="fa fa-users"></i>Clients</a></li>
                        <li style="font-size: 16px;"><a href="<?php echo site_url('branches_all');?>"><i class="fa fa-sitemap"></i> Branches</a></li>
                        ...
                        <li style="font-size: 16px;" > <a href="<?php echo site_url('reservations_admin');?>"><i class="fa fa-calendar"></i> Reservations</a></li>
                                ...
                                <li class="header-icon dib"><i class="ti-user" style="margin-right: 10px;"></i><span class="user-avatar" ><?php echo $this->session->userdata['user_username']; ?></span>
                                    <div class="drop-down dropdown-profile">
                                        <div class="dropdown-content-body">
                                            <ul>
                                                <li><a href="<?php echo site_url('logout');?>"><i class="ti-power-off"></i> <span>Logout</span></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </li>
